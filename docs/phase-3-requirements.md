...
4. Expand backend report APIs for all advanced chart data.
5. Wire advanced charts to backend-powered report payloads.
6. Add SMTP email sending for password reset.
7. Add OCR import pipeline.
8. Verify Google OAuth with real credentials.
